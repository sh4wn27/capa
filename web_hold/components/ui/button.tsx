...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-navy text-white shadow hover:bg-navy-700 active:scale-[0.98]",
        blush:
          "bg-blush text-white shadow hover:bg-blush-600 active:scale-[0.98]",
        outline:
          "border border-navy/20 bg-white text-navy shadow-sm hover:bg-navy/5 active:scale-[0.98]",
        ghost:
          "text-navy hover:bg-navy/5",
        secondary:
          "bg-navy-50 text-navy shadow-sm hover:bg-navy-100",
        link:
          "text-blush underline-offset-4 hover:underline",
      },
      size: {
