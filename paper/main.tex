...
the classical baselines (relapse 0.46, TRM 0.47), consistent with the known
...
\begin{table}[t!]
  ...
  \begin{tabular}{lccc}
    ...
    DeepHit (tabular HLA)          & --- & 0.464 (0.086--0.812) & 0.470 (0.273--0.679) \\
    \bottomrule
  \end{tabular}
\end{table}
...
on TRM ($C = 0.47$ vs.\ 0.65--0.66), illustrating a well-documented failure
